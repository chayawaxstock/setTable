...
export class ProductsService {
  getProductByIdOrder(id: any): Observable<Product[]>{
    return this.http.get<Product[]>("http://localhost:50596/api/Product/getOrderById/"+id)
  }
  editProduct(product: any) {
    return this.http.post("http://localhost:50596/api/Product/editProduct",product)
  }
  productEdit: any;
