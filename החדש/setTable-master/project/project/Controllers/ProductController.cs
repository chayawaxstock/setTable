...
namespace project.Controllers
{
    ...
    public class ProductController : ApiController
    {
     ...
     numberOfDiners)
        ...
        #region
        [HttpGet]
        [Route("getToCart/{idPlate}/{idGlass}/{numDiners}")]
        public List<DTO.Product> getToCart(int idPlate, int idGlass, int numDiners)
        {
            return BLL.ProductLogic.getToCart(idPlate, idGlass, numDiners);
        }
        #endregion
        [HttpPost]
        [Route("editProduct")]
        public bool getToCart(DTO.Product product)
        {
return BLL.ManegerLogic.editProduct(product);
        }

        [HttpGet]
        [Route("getOrderById/{id}")]
        public List<DTO.Product> getOrderById(int id)
        {
            return BLL.ProductLogic.getProductByIdOrder(id);
        }
    }
}